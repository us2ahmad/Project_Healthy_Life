              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="{{asset('admin/admin/assets/images/faces/face15.jpg')}}" alt="">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <tbody>
              ...
              <td>1.5</td>
              <td>magister</td>
              <td><a href="Mupdate trainer.html"><button class="btn btn-success btn-fw">update</button></a> </td>
                <td><button class="btn btn-danger btn-fw">delete</button></td>    
              </tr>
