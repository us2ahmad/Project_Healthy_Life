              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="{{asset('adminadmin//assets/images/faces/face15.jpg')}}" alt="">
                ...
                <div class="card">
                  ...
                  <div class=" container-fluid page-body-warper">
                    ...
                    <div style="padding: 15px;" class="col-sm-12">
                      ...
                      <input style="color:aliceblue" type="date" name="Birdth" placeholder="Give a Trainer Birdth" required="" height="10px" class="form-control p_input">
                      </div>
                    ...
                    <div style="padding: 15px;" class="col-sm-12">
                      ...
                      <input style="color:aliceblue" type="text" name="Address" placeholder="Give a Trainer Address" required="" height="10px" class="form-control p_input">
                        </div>
                      ...
                      <div style="padding: 15px;" class="col-sm-12">
                       ...
                       <div style="padding: 15px;" class="col-sm-12">
                        ...
                        <input  style="color:aliceblue" type="text" name="Cartificates" placeholder="Give a Trainer Experience" required="" height="10px" class="form-control p_input">
                        </div>
