    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link count-indicator" id="messageDropdown" href="chatify">
            <i class='bx bx-message-dots' style="font-size: 30px;"></i>
            <p class=" ms-2 mb-1 font-weight-medium">15</p>
          </li>
          <a href="/dashboard">
      ...
      <div class="container">
        ...
        <div class="row" style="display: flex; justify-content: center;">
          <div class="col-lg-4 col-md-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <a href="/player/faction of articl/training.html">
          ...
          <div class="col-lg-4 col-md-4 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <a href="/player/faction of articl/nutrition.html">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <a href="/player/faction of articl/health.html">
    ...
    <section id="cta" class="cta">
      <div class="container">
        <div class="text-center">
          ...
          <a class="cta-btn" href="/login.html">Join Now</a>
        </div>
      </div>
    </section>
    <!-- End Cta Section -->
  ...
  <form id="window" action="" class="position-fixed info-box">
    <fieldset class="d-flex align-items-center justify-content-center flex-column" style="background-color: rgba(23, 12, 12, 0.6);">
      ...
      <div class="link d-flex align-items-center justify-content-center">
        <a href="/player/tutorial/Mselftraining.html" class="btn-ok me-2" style="background-color: white;" ><img src="{{asset('/assets/img/images (1).png')}}" alt="" style="border-radius: 50%;" width="100px"></a>
        <a href="/player/tutorial/Feselftraining.html" class="btn-ok ms-2" style="background-color: white;"><img src="{{asset('/assets/img/download (1).png')}}" alt="" style="border-radius: 50%;" width="100px"></a>
      </div>
    </fieldset>
  </form>
      ...
      <div class="container">
        <div class="row section-title m-2 w-100">
          ...
          <div class="col-lg-4 py-5">
            <a href="/player/fcation/blabla.html">
          ...
          <div class="col-lg-4 py-5">
            <a href="/player/fcation/fitness-team.html">
              <div class="ts-item set-bg">
          ...
          <div class="col-lg-4 py-5">
            <a href="/player/fcation/balding-body-team.html">
              <div class="ts-item set-bg">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Offer</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="training.html">Training</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="indextutorial.html">Tutorial</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="index.html">Store</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="nutrition.html">Nutrition Consultant</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="health.html">Health Consultant</a></li>
            </ul>
          </div>
