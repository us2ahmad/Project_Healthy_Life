...
<section id="nutrition" class="d-flex align-items-center justify-content-center"></section>
  <div class= "isicontent clearfix"   >
    <div class="main-content">
     <div class= "post">
        <img src="{{asset('/assets/img/nutrifacts.jpg')}}" alt="" class="post-image" width="700" height="700">
...
<a href="{{route('player.article1')}}" class="btn-single read-more">Read More</a>
      ...
      <div class= "post">
        <img src="{{asset('/assets/img/nutritoon.jpg')}}" alt="" class="post-image" width="700" height="700">
        <div class="post-preview">
...
<a href="{{route('player.article2')}}" class="btn-single read-more">Read More</a>
      ...
      <div class= "post">
        <img src="{{asset('/assets/img/diet.jpg')}}" alt="" class="post-image" width="700" height="700">
        <div class="post-preview">
...
<a href="{{route('player.article3')}}" class="btn-single read-more">Read More</a>
      ...
      <div class= "post">
        <img src="{{asset('/assets/img/Vanill.jpg')}}" alt="" class="post-image">
        <div class="post-preview">
...
<a href="{{route('player.article4')}}" class="btn-single read-more">Read More</a>
      ...
      <div class= "post">
        <img src="{{asset('/assets/img/mikoprotein.jpg')}}" alt="" class="post-image" width="700" height="700">
        <div class="post-preview">
