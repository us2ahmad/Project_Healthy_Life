...
<section id="health" class="d-flex align-items-center justify-content-center"></section>
  <div class= "isicontent clearfix">
    <div class="main-content">
      ...
      <div class= "post">
        <img src="{{asset('/assets/img/publichealth.jpg')}}" alt="" class="post-image">
...
<a href="/player/faction of articl/health/health1.html" class="btn-single read-more">Read More</a>
      ...
      <div class= "post">
        <img src="{{asset('/assets/img/fitfit.jpg')}}" alt="" class="post-image">
        <div class="post-preview">
...
<a href="/player/faction of articl/health/health2.html" class="btn-single read-more">Read More</a>
      ...
      <div class= "post">
        <img src="{{asset('/assets/img/researcher.jpg')}}" alt="" class="post-image">
        <div class="post-preview">
...
<a href="/player/faction of articl/health/health3.html" class="btn-single read-more">Read More</a>
      ...
      <div class= "post">
        <img src="{{asset('/assets/img/beneficial.jpg')}}" alt="" class="post-image">
        <div class="post-preview">
