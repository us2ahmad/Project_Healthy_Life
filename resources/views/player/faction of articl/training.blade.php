...
<section id="training" class="d-flex align-items-center justify-content-center"></section>
  <div class= "isicontent clearfix">
    <div class="main-content">
      <h1 class="recent-post-title" style="color:grey">Training Consultant</h1>
...
<a href="yogatraining.html" class="btn-single read-more">Read More</a>
      ...
      <div class= "post">
        <img src="{{asset('assets/img/power-lifting.webp')}}" alt="" class="post-image">
        <div class="post-preview">
...
<a href="power_liftingtraining.html" class="btn-single read-more">Read More</a>
      ...
      <div class= "post">
        <img src="{{asset('assets/img/body-building.jpg')}}" alt="" class="post-image">
        <div class="post-preview">
